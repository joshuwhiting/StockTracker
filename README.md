...
A lightweight application to monitor real-time stock prices and manage your investment portfolio.
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/joshuwhiting/StockTracker.git](https://github.com/joshuwhiting/StockTracker.git)
   cd StockTracker
   # If using Python:
